...
exports.SAMGovSourceSource = void 0;
// SAM.gov — SAM.gov US government contractors
const base_1 = require("../base");
class SAMGovSourceSource extends base_1.BaseSource {
    name = "SAM.gov";
    id = "samgov";
    category = "government";
...
exports.SAMGovSourceSource = SAMGovSourceSource;
exports.default = new SAMGovSourceSource();
