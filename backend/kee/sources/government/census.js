...
exports.CensusSourceSource = void 0;
// US Census — US Census business data
const base_1 = require("../base");
class CensusSourceSource extends base_1.BaseSource {
    name = "US Census";
    id = "census";
    category = "government";
    ...
    async searchByNaics(naicsCode, options) {
...
exports.CensusSourceSource = CensusSourceSource;
exports.default = new CensusSourceSource();
