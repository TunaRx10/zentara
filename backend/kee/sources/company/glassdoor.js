...
exports.GlassdoorSourceSource = void 0;
// Glassdoor — Company reviews and salaries
const base_1 = require("../base");
class GlassdoorSourceSource extends base_1.BaseSource {
    name = "Glassdoor";
    id = "glassdoor";
    category = "company";
    requiresApiKey = true;
...
exports.GlassdoorSourceSource = GlassdoorSourceSource;
exports.default = new GlassdoorSourceSource();
