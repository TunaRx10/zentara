...
exports.IndeedSourceSource = void 0;
// Indeed — Job postings reveal company info
const base_1 = require("../base");
class IndeedSourceSource extends base_1.BaseSource {
    name = "Indeed";
    id = "indeed";
    category = "company";
    requiresApiKey = true;
...
exports.IndeedSourceSource = IndeedSourceSource;
exports.default = new IndeedSourceSource();
