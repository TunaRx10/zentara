...
exports.PinterestSourceSource = void 0;
// Pinterest — Pinterest business accounts
const base_1 = require("../base");
class PinterestSourceSource extends base_1.BaseSource {
    name = "Pinterest";
    id = "pinterest";
    category = "social";
    requiresApiKey = true;
...
exports.PinterestSourceSource = PinterestSourceSource;
exports.default = new PinterestSourceSource();
