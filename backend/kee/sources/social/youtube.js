...
exports.YouTubeSourceSource = void 0;
// YouTube — YouTube channel data
const base_1 = require("../base");
class YouTubeSourceSource extends base_1.BaseSource {
    name = "YouTube";
    id = "youtube";
    category = "social";
    requiresApiKey = true;
...
exports.YouTubeSourceSource = YouTubeSourceSource;
exports.default = new YouTubeSourceSource();
