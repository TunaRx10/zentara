...
exports.TikTokSourceSource = void 0;
// TikTok — TikTok creator profiles
const base_1 = require("../base");
class TikTokSourceSource extends base_1.BaseSource {
    name = "TikTok";
    id = "tiktok";
    category = "social";
    requiresApiKey = true;
...
exports.TikTokSourceSource = TikTokSourceSource;
exports.default = new TikTokSourceSource();
