...
exports.HomeAdvisorSourceSource = void 0;
// HomeAdvisor — Home services directory
const base_1 = require("../base");
class HomeAdvisorSourceSource extends base_1.BaseSource {
    name = "HomeAdvisor";
    id = "homeadvisor";
    category = "local";
    requiresApiKey = true;
...
exports.HomeAdvisorSourceSource = HomeAdvisorSourceSource;
exports.default = new HomeAdvisorSourceSource();
