...
exports.YelpSource2Source = void 0;
// Yelp — Yelp Fusion API
const base_1 = require("../base");
class YelpSource2Source extends base_1.BaseSource {
    name = "Yelp";
    id = "yelp";
    category = "local";
    requiresApiKey = true;
...
exports.YelpSource2Source = YelpSource2Source;
exports.default = new YelpSource2Source();
