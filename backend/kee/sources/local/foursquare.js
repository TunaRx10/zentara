...
exports.FoursquareSourceSource = void 0;
// Foursquare — Foursquare Places API
const base_1 = require("../base");
class FoursquareSourceSource extends base_1.BaseSource {
    name = "Foursquare";
    id = "foursquare";
    category = "local";
    requiresApiKey = true;
...
exports.FoursquareSourceSource = FoursquareSourceSource;
exports.default = new FoursquareSourceSource();
