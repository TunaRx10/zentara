...
exports.GoogleMapsSource2Source = void 0;
// Google Maps — Google Places API
const base_1 = require("../base");
class GoogleMapsSource2Source extends base_1.BaseSource {
    name = "Google Maps";
    id = "google-maps";
    category = "local";
    requiresApiKey = true;
...
exports.GoogleMapsSource2Source = GoogleMapsSource2Source;
exports.default = new GoogleMapsSource2Source();
