...
exports.ThumbtackSourceSource = void 0;
// Thumbtack — Local service providers
const base_1 = require("../base");
class ThumbtackSourceSource extends base_1.BaseSource {
    name = "Thumbtack";
    id = "thumbtack";
    category = "local";
    requiresApiKey = true;
...
exports.ThumbtackSourceSource = ThumbtackSourceSource;
exports.default = new ThumbtackSourceSource();
