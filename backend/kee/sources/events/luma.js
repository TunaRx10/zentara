...
exports.LumaSourceSource = void 0;
// Luma — Luma events
const base_1 = require("../base");
class LumaSourceSource extends base_1.BaseSource {
    name = "Luma";
    id = "luma";
    category = "events";
    requiresApiKey = true;
...
exports.LumaSourceSource = LumaSourceSource;
exports.default = new LumaSourceSource();
