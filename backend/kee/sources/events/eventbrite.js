...
exports.EventbriteSourceSource = void 0;
// Eventbrite — Eventbrite attendees/speakers
const base_1 = require("../base");
class EventbriteSourceSource extends base_1.BaseSource {
    name = "Eventbrite";
    id = "eventbrite";
    category = "events";
    requiresApiKey = true;
...
exports.EventbriteSourceSource = EventbriteSourceSource;
exports.default = new EventbriteSourceSource();
