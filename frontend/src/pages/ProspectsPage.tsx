...
function AddProspectModal({ open, onClose, onCreated }: AddProspectModalProps): React.ReactElement | null {
  ...
  const handleSubmit = async () => {
    ...
    try {
      await createMut.mutateAsync({
        ...
        // Status enum (Round 24) — backend attend 'new' | 'qualified'
      ...
      // Stay open; surface via createMut.error (displayed below).
      void e;
    }
  };
        ...
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-0.5">
              Renseignes le minimum. Tu pourras enrichir la fiche ensuite.
            </p>
          </div>
          <button
            type="button"
